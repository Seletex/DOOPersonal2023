...
import co.edu.uco.tiendaonline.service.businesslogic.validator.concrete.tipoidentificacion.EliminarTipoIdentificacionValidator;
...
public final class EliminarTipoIdentificacionFacade implements Facade<TipoIdentificacionDTO> {
	...
	public void execute(final TipoIdentificacionDTO dto) {
		...
		EliminarTipoIdentificacionValidator.ejecutarValidacion(domain);
