...
import co.edu.uco.tiendaonline.service.domain.cliente.rules.support.nombre.NombreCompletoClienteValidationRule;
import co.edu.uco.tiendaonline.service.domain.cliente.support.NombreCompletoClienteDomain;

public class CorreoElectronicoValidationRule  implements ValidationRule<NombreCompletoClienteDomain> {
