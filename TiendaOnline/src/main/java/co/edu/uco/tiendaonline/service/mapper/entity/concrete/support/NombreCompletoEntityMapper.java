...
public class NombreCompletoEntityMapper implements EntityMapper<NombreCompletoClienteEntity, NombreCompletoClienteDomain> {

	private static final EntityMapper<NombreCompletoClienteEntity, NombreCompletoClienteDomain>
	instancia = new NombreCompletoEntityMapper();
	...
	public static final NombreCompletoClienteDomain converToDomain(final NombreCompletoClienteEntity entity) {
		return instancia.toDomain(entity);
	}
	
	public static final NombreCompletoClienteEntity converToEntity(final NombreCompletoClienteDomain domain) {
