...
public class CorreoCorreoElectronicoClienteValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new CorreoCorreoElectronicoClienteValidationRule();
