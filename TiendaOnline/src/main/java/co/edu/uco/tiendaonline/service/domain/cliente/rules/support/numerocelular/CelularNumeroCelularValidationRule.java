...
public class CelularNumeroCelularValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new CelularNumeroCelularValidationRule();
